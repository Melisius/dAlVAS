...
def test_AVAS_nosymmetry():
    ...
    A.set_atomic_valence_selection("data/testfiles/input_integral_FeNOCO3.out","data/testfiles/input_integral_FeNOCO3.AOONEINT",{"Fe":"d"})
    A.AVAS()
...
def test_AVAS_symmetry():
    ...
    A.set_atomic_valence_selection("data/testfiles/input_integral_FeNOCO3_sym.out","data/testfiles/input_integral_FeNOCO3_sym.AOONEINT",{"Fe":"d"})
    A.AVAS()
